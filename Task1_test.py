...
def test_clean_albums_df_removes_unneeded_columns():
    ...
    for i in [ 'track_name' , 'release_date', 'label', 'track_id', 'duration_ms']:
        assert i in cleaned_df.columns  
# all important columns should remain after cleaning.
    print('Testing complete, clean_albums_df module working as expected.') # This line is for confirmation, in case of failiure asssertions will raise errors.
...
def test_transform_and_merge_filters_correctly():
    ...
    print('Testing complete, transform_and_merge module working as expected.') # This line is for confirmation, in case of failiure asssertions will raise errors.
